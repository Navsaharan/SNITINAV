...
export default function EditPage() {
  ...
  const fetchPage = useCallback(async () => {
    try {
      ...
      setValue('metaDesc', pageData.metaDesc || '')
      setValue('status', pageData.status)
      setValue('parentId', pageData.parentId || '')
      setValue('navigationCategory', pageData.navigationCategory || '')
      setValue('navigationOrder', pageData.navigationOrder || 0)
    } catch (error) {
  ...
  const fetchPages = useCallback(async () => {
    try {
      ...
      if (response.ok) {
        ...
        setPages(pagesData.filter((p: Page) => p.id !== pageId))
      }
    } catch (error) {
    ...
    return (
      <AdminLayout>
        <div className="text-center py-12">
          ...
          <Link href="/admin/pages" className="text-blue-600 hover:text-blue-800 mt-4 inline-block">
            Back to Pages
          </Link>
        </div>
      </AdminLayout>
        ...
        <div className="flex justify-between items-center mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Editing: {page.title}</p>
            </div>
          </div>
